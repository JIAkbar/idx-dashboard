...
| # | Pekerjaan | Asal | Keadaan · Bukti/penghalang |
|---|---|---|---|
| B10 | A1 — Rata-rata 5 tahun + ambang verdict valuasi | `ceklist-backlog.md` A1 | **SELESAI 20 Agu 2026** (`ec318fd2`, jejak #205). Panel *Valuasi vs Sejarah* di Stock Detail: deret P/E & P/B tahun buku 2019–2025 (`valuasi_historis.json`, 814 emiten, nol jaringan), ambang = kuartil 25/75 emiten itu sendiri, jangkar median. Riwayat <5 tahun tak diberi vonis — 338 emiten layak vonis P/E, 574 layak P/B |
...
| B26 | B3(ceklist) — Pemegang saham pengendali | `ceklist-backlog.md` B3, `rencana-berjalan.md` #158 | **SELESAI SEBAGIAN 20 Agu 2026** (`b6b1e330`, jejak #204). 949 emiten di `pengendali.json`, tampil di hero Stock Detail dengan tanggal laporannya. **Yang TIDAK tertutup:** laporan resmi cuma memuat **kategori** pengendali (8 nilai), bukan NAMA — 47 sheet BBCA & ASII sudah disisir, daftar nama pemegang saham tak ada di XBRL. #158/#155 (nama & grup konglomerat) tetap butuh sumber lain: KSEI atau prospektus |
