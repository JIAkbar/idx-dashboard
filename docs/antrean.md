...
| B24 | **Panen 3.113 XLSX: 2020-audit, 2021-audit, 2025-audit, 2026-TW2** | `antrean.md` B22/B23 (D7 + D8) | **MENUNGGU KEPUTUSAN JOHAN.** Ongkos terukur 20 Agu: 3.113 unduhan, ~1,4 GB arsip, ~31 menit, WAJIB IP rumahan. Ketersediaan sudah dipastikan (`panen_keuangan_idx.py --periksa-ketersediaan`). Dua hasil sekaligus: 3.099 mata uang naik dari DITAKSIR jadi TERBACA, dan ARGO 2020/2021 + LAPD 2021 akhirnya punya arsip mentah — D12 ("tak bisa ditambal karena arsipnya tak ada") gugur. **JANGAN `--paksa` atas seluruh arsip.** Sesudah panen: jalankan ulang `turunkan_kuartal_diskret.py`, `cacat_sumber.py --tandai`, dan `sapu_regresi_keuangan.py` lalu tinjau ulang keempat tanda `cacat` |
