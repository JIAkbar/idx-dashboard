...
| ☐ | 15 | **A2** | Bedah Emiten — 12 section, satu commit per section | A0 ✅ + A1 | Padanan sple-mf, plus Altman Z & F-Score yang tak mereka punya. **BELUM sebagai halaman.** Jangan tertukar: `arus-pasar/build_bedah.py` + tab admin `BedahTab` itu **edisi terbitan** "Deep Dive" (dulu "Bedah Arus Saham", diganti nama 21 Agu 2026), bukan halaman analisa 12 section |
