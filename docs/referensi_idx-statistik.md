...
- **Prasyarat yang masih terbuka (Johan):** tabel `live_token` masih **0 baris** (temuan Papan 8 Sep, #92) — sebelum disemai (SOP `scripts/cek_token.py --semai` dengan akun kedua), proxy menjawab 503 dan semua halaman diam-diam memakai arsip harian.
