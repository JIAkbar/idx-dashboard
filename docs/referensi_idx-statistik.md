...
**Pengecualian yang tidak disamakan** (bukan rentang mundur, keputusan yang sama butir 5): tahun awal Musiman, jenis edisi Statistik Berkala, jendela pekan Rotasi, tahun histori Neo Seasonality, jendela 2/3/10/20 hari Broker Stalker, dan Panel Diary pasar di Beranda (sembilan baris performa 1D sampai 5Y ditampilkan sekaligus dari ruas sumbernya, bukan pemilih yang bisa diklik; labelnya dari `LABEL_RENTANG`). **Batas yang tersisa:** Top Broker dan Rincian Broker membaca rentang yang dihitung skrip panen (`bangun_broker_rentang.py`, `bangun_broker_pivot.py`), jadi hanya daftar dan katanya yang baku; angkanya masih definisi skrip lama dan presetnya lebih sedikit (usulan antrean #211). Broker Stalker adalah pemilih rentang mundur yang dikecualikan keputusan butir 5; usulan penyamaannya antrean #210.
