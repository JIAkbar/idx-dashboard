...
| **Broker summary — PER EMITEN** | Deep Dive, Kartu Analisa | Setoran kontributor (screenshot) — **tak ada di endpoint publik mana pun**; diuji ulang 22 Agu 2026: `code`/`stockCode`/`kodeEmiten` diabaikan, jawaban identik 88 baris level pasar | ikut setoran | — | 👤 kontributor + kurasi admin | halaman `/admin` |
