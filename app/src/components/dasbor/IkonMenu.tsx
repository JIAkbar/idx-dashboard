...
// Empat petak — ganti glyph Unicode '⊞' literal di tab Kuadran (K6 #170:
// satu baris tab tak boleh mencampur dua sistem ikon).
export const IKON_KUADRAN = 'M4 4h7v7H4V4zm9 0h7v7h-7V4zM4 13h7v7H4v-7zm9 0h7v7h-7v-7z'
